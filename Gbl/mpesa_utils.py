...
#     print("Raw Response:", response.text)  # Add this to check the raw response
...
#         # Check if MPESA request was successful
#         if response.status_code == 200:
#             return jsonify(response.json()), 200
#         else:
#             return jsonify({
#                 "error": "Failed to initiate STK push",
#                 "mpesa_response": response.text  # Return Safaricom's error message
