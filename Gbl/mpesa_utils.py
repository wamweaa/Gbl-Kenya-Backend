...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://neondb_owner:npg_CmQ1eKcfbi7P@ep-bold-shape-a8sgvun3-pooler.eastus2.azure.neon.tech/neondb?sslmode=require')
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'supersecretkey')
cloudinary.config(
    cloud_name=os.getenv('CLOUDINARY_CLOUD_NAME', 'dpt8hh1wl'),
    api_key=os.getenv('CLOUDINARY_API_KEY', '422452375893439'),
    api_secret=os.getenv('CLOUDINARY_API_SECRET', 'vgnbC8kSSYCap3JuW1IC_uzmYe4')
)
